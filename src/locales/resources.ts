  ...
  "zh-CN": {
    ...
    workbench: {
      ...
      toasts: {
        ...
        gatewayEmptyResponse: "模型没有返回可用内容，请重试。",
        gatewayUnavailable: "无法连接本地优化网关。若刚修改过配置，请重启 Vite 服务后再试。",
        gatewayRequestFailed: "优化失败：{{message}}",
      },
      badges: {
        vague: "模糊",
        unclear: "不清晰",
  ...
  en: {
    ...
    workbench: {
      ...
      states: {
        ...
        streamingVersion: "Streaming optimized prompt...",
        ready: "Ready",
      ...
      toasts: {
        ...
        gatewayEmptyResponse: "The model returned no usable content. Try again.",
        gatewayUnavailable: "Unable to reach the local optimization gateway. Restart the Vite server if you just changed the proxy settings.",
        gatewayRequestFailed: "Optimization failed: {{message}}",
      },
      badges: {
        vague: "Vague",
        unclear: "Unclear",
